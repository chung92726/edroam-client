...
const BecomeInstructor = ({ userBeInstructorPage }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // console.log(data);
      toast.success(`${userBeInstructorPage.toast_updated}`);
      router.push('/user/create-stripe');
    } catch (err) {
      console.log(err);
      toast.error(`${userBeInstructorPage.toast_failed}`);
      ...
      {ok && values && (
        <>
          ...
          <div className='form-control justify-center items-center w-[90%] max-w-xl'>
            <label className='label'>
              <span className='label-text'>
                {userBeInstructorPage.Upload_ProfileImg}
              </span>
            </label>
            <input
              type='file'
          ...
          <div className='flex flex-col justify-center items-center gap-3 mt-5 w-[90%]'>
            <p>{userBeInstructorPage.Notice}</p>
            <div className='form-control w-full max-w-xl mx-2'>
              <label className='label'>
                <span className='label-text'>{userBeInstructorPage.Email}</span>
              </label>
              <input
                type='text'
                name='email'
            ...
            <div className='form-control w-full max-w-xl mx-2'>
              <label className='label'>
                <span className='label-text'>{userBeInstructorPage.Name}</span>
              </label>
              <input
                type='text'
                name='name'
            ...
            <div className='form-control w-full max-w-xl mx-2'>
              <label className='label'>
                <span className='label-text'>{userBeInstructorPage.Age}</span>
              </label>
              <select
              ...
              >
                <option disabled value=''>
                  {userBeInstructorPage.ChooseAge}
                </option>
                <option value='1'>18 {userBeInstructorPage.To} 24</option>
                <option value='2'>25 {userBeInstructorPage.To} 34</option>
                <option value='3'>35 {userBeInstructorPage.To} 44</option>
                <option value='4'>45 {userBeInstructorPage.To} 54</option>
                <option value='5'>55 {userBeInstructorPage.To} 64</option>
                <option value='6'>65 {userBeInstructorPage.Over}</option>
              </select>
            </div>
            <div className='form-control w-full max-w-xl mx-2'>
              <label className='label'>
                <span className='label-text'>
                  {userBeInstructorPage.Website}
                </span>
              </label>
              {/* <h1>Website</h1> */}
              <input
                type='text'
                name='website'
                placeholder={`${userBeInstructorPage.Placeholder_eg} www.x-learner.com`}
                onChange={handleChange}
            ...
            <div className='form-control w-full max-w-xl mx-2'>
              ...
              <input
                type='text'
                name='youtube'
                placeholder={`${userBeInstructorPage.Placeholder_eg} www.youtube.com/@username`}
                onChange={handleChange}
            ...
            <div className='form-control w-full max-w-xl mx-2'>
              ...
              <input
                type='text'
                name='facebook'
                placeholder={`${userBeInstructorPage.Placeholder_eg} www.facebook.com/username`}
                onChange={handleChange}
            ...
            <div className='form-control w-full max-w-xl mx-2'>
              <label className='label'>
                <span className='label-text'>
                  {userBeInstructorPage.Instagram}
                </span>
              </label>
              {/* <h1>Website</h1> */}
              <input
                type='text'
                name='instagram'
                placeholder={`${userBeInstructorPage.Placeholder_eg} www.instagram/username`}
                onChange={handleChange}
            ...
            <div className='form-control w-full max-w-xl mx-2'>
              ...
              <input
                type='text'
                name='twitter'
                placeholder={`${userBeInstructorPage.Placeholder_eg} www.twitter.com/username`}
                onChange={handleChange}
            ...
            <div className='form-control w-full max-w-xl mx-2'>
              ...
              <input
                type='text'
                name='wechat'
                placeholder={userBeInstructorPage.WechatId}
                onChange={handleChange}
                value={values.wechat}
                className='input input-bordered'
                disabled={values.loading}
            ...
            <div className='form-control w-full max-w-xl mx-2'>
              ...
              <input
                type='text'
                name='tiktok'
                placeholder={`${userBeInstructorPage.Placeholder_eg} www.tiktok.com/@username`}
                onChange={handleChange}
                value={values.tiktok}
                className='input input-bordered'
                disabled={values.loading}
            ...
            <div className='form-control w-full max-w-xl mx-2'>
              <label className='label'>
                <span className='label-text'>
                  {userBeInstructorPage.Contact_no}
                </span>
              </label>
              ...
              <input
                type='text'
                name='phoneNumber'
                placeholder={`${userBeInstructorPage.Placeholder_eg} +852 12345678`}
                ref={phoneNumberRef}
                onChange={handleChange}
          ...
          /> */}
            <div className='form-control w-full max-w-xl mx-2'>
              <label className='label'>
                <span className='label-text'>{userBeInstructorPage.Bio}</span>
              </label>
              {/* <h1>Biography</h1> */}
              <textarea
                type='text'
                name='biography'
                placeholder={userBeInstructorPage.Bio_Placeholder}
                ref={biographyRef}
                onChange={handleChange}
            ...
            <div className='form-control w-full max-w-xl mx-2'>
              ...
              <textarea
                ...
                placeholder={userBeInstructorPage.TeachExp_Placeholder}
            ...
            <div className='form-control w-full max-w-xl mx-2'>
              <label className='label'>
                <span className='label-text'>
                  {userBeInstructorPage.Course_Detail}
                </span>
              </label>
              ...
              <textarea
                type='text'
                name='courseDetails'
                placeholder={userBeInstructorPage.Course_Detail_Placeholder}
              ...
              >
                {values.loading ? (
                  <>
                    ...
                    {userBeInstructorPage.Loading}
                  </>
                ) : (
                  <>{userBeInstructorPage.Continue}</>
                )}
              </button>
            </div>
          </div>
