...
const UserIndex = () => {
  ...
  return (
    <UserRoute>
      ...
      {filtered && (
        <div className="flex flex-row justify-center items-center flex-wrap gap-6 my-10 mx-5 sm:justify-start">
          {filtered.map((course) => (
            <Link
              className="card w-60 border-none cursor-pointer group bg-white"
